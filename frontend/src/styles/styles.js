const styles = {
    ...
    button: 'w-[150px] bg-[#143d59] h-[40px] my-2 flex items-center justify-center rounded-xl cursor-pointer',
    ...
    activeStatus:"w-[10px] h-[10px] rounded-full absolute top-0 right-1 bg-[#fefe]",
